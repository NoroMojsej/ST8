...
Route::put('/user/changeRole/{userId}', [UserController::class, 'changeRole'])->middleware('auth:sanctum');
Route::get('/user/{userId}', [UserController::class, 'getUserInfo']);
Route::put('/user/changePassword/{userId}', [UserController::class, 'changePassword'])->middleware('auth:sanctum');
Route::put('/updateUser/{userId}', [UserController::class, 'updateUser'])->middleware('auth:sanctum');
...
Route::post('/reviews/create-review', [ReviewController::class, 'createReview'])->middleware('auth:sanctum');
Route::post('/reviews/save-review', [ReviewController::class, 'saveReview'])->middleware('auth:sanctum');
Route::post('/reviews/delete-review', [ReviewController::class, 'deleteReview'])->middleware('auth:sanctum');
Route::get('/conferences', [ConferenceController::class, 'index']);
Route::post('/createConf', [ConferenceController::class, 'store'])->middleware('auth:sanctum');
Route::get('/conferences/active', [ConferenceController::class, 'getActiveConferences']);
Route::put('/conference/update/{conferenceId}', [ConferenceController::class, 'updateConference'])->middleware('auth:sanctum');
...
Route::post('/papers/assign/{userId}', [ReviewController::class, 'createReviewAndUpdatePaper'])->middleware('auth:sanctum');  
...
Route::put('/papers/update/{essayId}', [PaperController::class, 'updateEssayByID'])->middleware('auth:sanctum');
Route::post('/papers/update/{essayId}/upload-files', [PaperController::class, 'uploadFiles'])->middleware('auth:sanctum');
Route::get('/sections/get-all-sections', [SectionController::class, 'getAllSections']);
Route::post('/sections/save-section', [SectionController::class, 'saveSection'])->middleware('auth:sanctum');
Route::post('/sections/delete-section', [SectionController::class, 'deleteSection'])->middleware('auth:sanctum');
...
Route::post('/upload-paper/{userId}', [PaperController::class, 'uploadPaper'])->middleware('auth:sanctum'); // môže sa aj takto, ajtak ho to nepustí uploadnuť.
Route::post('/update-paper/{id}/{userId}', [PaperController::class, 'updatePaper'])->middleware('auth:sanctum'); // PUT z nejakého dôvodu nefunguje s file-uploadom, zmena na post.
Route::delete('/delete-paper/{id}/{userId}', [PaperController::class, 'deletePaper'])->middleware('auth:sanctum'); // mazanie papers (non-admin).
Route::get('/papers/conference/{conferenceId}', [PaperController::class, 'getPapersByConference']); // papers pre danú konferenciu.

Route::post('/faculties/create', [FacultyController::class, 'create'])->middleware('auth:sanctum');
...
Route::post('/faculties/update/{id}', [FacultyController::class, 'update'])->middleware('auth:sanctum');
Route::delete('/faculties/delete/{id}', [FacultyController::class, 'deleteById'])->middleware('auth:sanctum');

Route::post('/departments/create', [DepartmentController::class, 'create'])->middleware('auth:sanctum'); // Create department
Route::get('/departments/{facultyId}', [DepartmentController::class, 'getDepartments']); //
Route::get('/departments/getdepartment/{id}', [DepartmentController::class, 'getById']); // Get department by ID
Route::post('/departments/update/{id}', [DepartmentController::class, 'update'])->middleware('auth:sanctum'); // Edit department by ID
Route::delete('/departments/deletedepartment/{id}', [DepartmentController::class, 'deleteById'])->middleware('auth:sanctum'); // Remove department by ID

Route::post('/universities/create', [UniversityController::class, 'create'])->middleware('auth:sanctum');
Route::get('/universities/university/{id}', [UniversityController::class, 'getById']);
Route::post('/universities/update/{id}', [UniversityController::class, 'update'])->middleware('auth:sanctum');
