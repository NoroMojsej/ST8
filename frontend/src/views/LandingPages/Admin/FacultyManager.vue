...
const faculty = ref([
  { id: 1, fac: "Fakulta 1", desc: "Adresa napr." },
  { id: 2, fac: "Fakulta 2", desc: "Adresa napr." },
  { id: 3, fac: "Fakulta 3", desc: "Adresa napr." },
  { id: 4, fac: "Fakulta 4", desc: "Adresa napr." },
]);
...
function handleDelete(id) {
  faculty.value = faculty.value.filter((fac) => fac.id !== id);
}
      ...
      >
        <div class="col-12">
          <div class="d-flex align-items-center">
            ...
            <button class="btn btn-danger ms-3 mt-n3" @click="() => handleDelete(fac.id)">Vymazať</button>
          </div>
        </div>
      </div>
    </div>
